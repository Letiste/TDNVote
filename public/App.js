...
const css$2 = {
	code: "main.svelte-rvczwr.svelte-rvczwr{font-family:'Abhaya Libre';font-size:2.5rem}.titleContainer.svelte-rvczwr.svelte-rvczwr{background-image:linear-gradient(\n      45deg,\n      rgb(18, 26, 58) 0%,\n      rgb(39, 9, 55) 100%\n    );height:30rem;display:flex;justify-content:center;align-items:center}h1.svelte-rvczwr.svelte-rvczwr{font-family:'Rye';font-size:6rem;color:#ffde59;text-align:center}.mainContainer.svelte-rvczwr.svelte-rvczwr{margin:-60px 30px 0;border-radius:6px;box-shadow:0 16px 24px 2px rgba(0, 0, 0, 0.14),\n      0 6px 30px 5px rgba(0, 0, 0, 0.12), 0 8px 10px -5px rgba(0, 0, 0, 0.2);background-color:#fff;background-size:contain;margin-bottom:50px;padding-bottom:50px;display:flex;flex-direction:column;align-items:center;box-sizing:content-box}h2.svelte-rvczwr.svelte-rvczwr{font-family:'Rye';font-size:3rem;padding-top:40px;text-align:center}.errors.svelte-rvczwr li.svelte-rvczwr{color:rgb(200, 0, 0);list-style:none;font-size:1.5rem;font-weight:bold}form.svelte-rvczwr.svelte-rvczwr{font-family:'Abhaya Libre';display:flex;flex-direction:column;padding:50px;font-size:2rem;border-top:2px solid rgba(39, 9, 55, 0.5)}label.svelte-rvczwr.svelte-rvczwr{align-self:center}input.svelte-rvczwr.svelte-rvczwr{font-size:2rem;margin:15px;border:2px solid rgb(39, 9, 55);border-radius:10px;padding:5px;font-family:'Abhaya Libre';transition:all 250ms}input.svelte-rvczwr.svelte-rvczwr:hover,input.svelte-rvczwr.svelte-rvczwr:focus{border-color:#ffde59;border-radius:10px}button.svelte-rvczwr.svelte-rvczwr{border:2px solid rgb(39, 9, 55);border-radius:10px;padding:10px;font-size:2.5rem;margin-top:20px;font-family:'Abhaya Libre';font-weight:bold;background-color:rgb(39, 9, 55);color:#ffde59;cursor:pointer}",
	map: "{\"version\":3,\"file\":\"Login.svelte\",\"sources\":[\"Login.svelte\"],\"sourcesContent\":[\"<script>\\n  let errors = [];\\n\\n  let username = '';\\n  let password = '';\\n\\n  function handleErrors(err) {\\n    err.response.data.message.forEach(({ message }) => {\\n      let error;\\n      if (message.includes('max'))\\n        error = 'Le n° de ticket doit être inférieur à 200';\\n      else if (message.includes('min'))\\n        error = 'Ce n° de ticket doit être supérieur à 0';\\n      else if (message.includes('unique'))\\n        error = 'Ce n° de ticket a déjà été utilisé';\\n      else error = message;\\n      errors = [...errors, error];\\n    });\\n  }\\n\\n  function handleSubmit() {\\n    console.log(username, password);\\n  }\\n</script>\\n\\n<style>\\n  main {\\n    font-family: 'Abhaya Libre';\\n    font-size: 2.5rem;\\n  }\\n  .titleContainer {\\n    background-image: linear-gradient(\\n      45deg,\\n      rgb(18, 26, 58) 0%,\\n      rgb(39, 9, 55) 100%\\n    );\\n    height: 30rem;\\n    display: flex;\\n    justify-content: center;\\n    align-items: center;\\n  }\\n\\n  h1 {\\n    font-family: 'Rye';\\n    font-size: 6rem;\\n    color: #ffde59;\\n    text-align: center;\\n  }\\n\\n  .mainContainer {\\n    margin: -60px 30px 0;\\n    border-radius: 6px;\\n    box-shadow: 0 16px 24px 2px rgba(0, 0, 0, 0.14),\\n      0 6px 30px 5px rgba(0, 0, 0, 0.12), 0 8px 10px -5px rgba(0, 0, 0, 0.2);\\n    background-color: #fff;\\n    background-size: contain;\\n    margin-bottom: 50px;\\n    padding-bottom: 50px;\\n    display: flex;\\n    flex-direction: column;\\n    align-items: center;\\n    box-sizing: content-box;\\n  }\\n\\n  h2 {\\n    font-family: 'Rye';\\n    font-size: 3rem;\\n    padding-top: 40px;\\n    text-align: center;\\n  }\\n\\n  .errors li {\\n    color: rgb(200, 0, 0);\\n    list-style: none;\\n    font-size: 1.5rem;\\n    font-weight: bold;\\n  }\\n\\n  form {\\n    font-family: 'Abhaya Libre';\\n    display: flex;\\n    flex-direction: column;\\n    padding: 50px;\\n    font-size: 2rem;\\n    border-top: 2px solid rgba(39, 9, 55, 0.5);\\n  }\\n\\n  label {\\n    align-self: center;\\n  }\\n\\n  select {\\n    font-size: 2rem;\\n    margin: 15px;\\n    border: 2px solid rgb(39, 9, 55);\\n    border-radius: 10px;\\n    padding: 5px;\\n    background-color: #fff;\\n    font-family: 'Abhaya Libre';\\n    appearance: none;\\n    -webkit-appearance: none;\\n    -moz-appearance: none;\\n    cursor: pointer;\\n  }\\n\\n  .ticket {\\n    display: flex;\\n    flex-wrap: nowrap;\\n  }\\n\\n  input {\\n    font-size: 2rem;\\n    margin: 15px;\\n    border: 2px solid rgb(39, 9, 55);\\n    border-radius: 10px;\\n    padding: 5px;\\n    font-family: 'Abhaya Libre';\\n    transition: all 250ms;\\n  }\\n\\n  input:hover,\\n  input:focus,\\n  select:hover,\\n  select:focus {\\n    border-color: #ffde59;\\n    border-radius: 10px;\\n  }\\n\\n  button {\\n    border: 2px solid rgb(39, 9, 55);\\n    border-radius: 10px;\\n    padding: 10px;\\n    font-size: 2.5rem;\\n    margin-top: 20px;\\n    font-family: 'Abhaya Libre';\\n    font-weight: bold;\\n    background-color: rgb(39, 9, 55);\\n    color: #ffde59;\\n    cursor: pointer;\\n  }\\n</style>\\n\\n<main>\\n  <div class=\\\"titleContainer\\\">\\n    <h1>Talents du Nord</h1>\\n  </div>\\n\\n  <div class=\\\"mainContainer\\\">\\n    <h2>Login</h2>\\n\\n    <div class=\\\"errors\\\">\\n      <ul>\\n        {#each errors as error}\\n          <li>{error}</li>\\n        {/each}\\n      </ul>\\n    </div>\\n\\n    <form on:submit|preventDefault={handleSubmit}>\\n      <label for=\\\"username\\\">Username</label>\\n      <input type=\\\"text\\\" id=\\\"username\\\" bind:value={username} required />\\n\\n      <label for=\\\"password\\\">Password</label>\\n      <input type=\\\"password\\\" id=\\\"password\\\" bind:value={password} required />\\n\\n      <button type=\\\"submit\\\">Login</button>\\n    </form>\\n  </div>\\n</main>\\n\"],\"names\":[],\"mappings\":\"AA0BE,IAAI,4BAAC,CAAC,AACJ,WAAW,CAAE,cAAc,CAC3B,SAAS,CAAE,MAAM,AACnB,CAAC,AACD,eAAe,4BAAC,CAAC,AACf,gBAAgB,CAAE;MAChB,KAAK,CAAC;MACN,IAAI,EAAE,CAAC,CAAC,EAAE,CAAC,CAAC,EAAE,CAAC,CAAC,EAAE,CAAC;MACnB,IAAI,EAAE,CAAC,CAAC,CAAC,CAAC,CAAC,EAAE,CAAC,CAAC,IAAI;KACpB,CACD,MAAM,CAAE,KAAK,CACb,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,AACrB,CAAC,AAED,EAAE,4BAAC,CAAC,AACF,WAAW,CAAE,KAAK,CAClB,SAAS,CAAE,IAAI,CACf,KAAK,CAAE,OAAO,CACd,UAAU,CAAE,MAAM,AACpB,CAAC,AAED,cAAc,4BAAC,CAAC,AACd,MAAM,CAAE,KAAK,CAAC,IAAI,CAAC,CAAC,CACpB,aAAa,CAAE,GAAG,CAClB,UAAU,CAAE,CAAC,CAAC,IAAI,CAAC,IAAI,CAAC,GAAG,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC;MAC9C,CAAC,CAAC,GAAG,CAAC,IAAI,CAAC,GAAG,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,IAAI,CAAC,IAAI,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CACxE,gBAAgB,CAAE,IAAI,CACtB,eAAe,CAAE,OAAO,CACxB,aAAa,CAAE,IAAI,CACnB,cAAc,CAAE,IAAI,CACpB,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,WAAW,CAAE,MAAM,CACnB,UAAU,CAAE,WAAW,AACzB,CAAC,AAED,EAAE,4BAAC,CAAC,AACF,WAAW,CAAE,KAAK,CAClB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,IAAI,CACjB,UAAU,CAAE,MAAM,AACpB,CAAC,AAED,qBAAO,CAAC,EAAE,cAAC,CAAC,AACV,KAAK,CAAE,IAAI,GAAG,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CACrB,UAAU,CAAE,IAAI,CAChB,SAAS,CAAE,MAAM,CACjB,WAAW,CAAE,IAAI,AACnB,CAAC,AAED,IAAI,4BAAC,CAAC,AACJ,WAAW,CAAE,cAAc,CAC3B,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,OAAO,CAAE,IAAI,CACb,SAAS,CAAE,IAAI,CACf,UAAU,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,EAAE,CAAC,CAAC,CAAC,CAAC,CAAC,EAAE,CAAC,CAAC,GAAG,CAAC,AAC5C,CAAC,AAED,KAAK,4BAAC,CAAC,AACL,UAAU,CAAE,MAAM,AACpB,CAAC,AAqBD,KAAK,4BAAC,CAAC,AACL,SAAS,CAAE,IAAI,CACf,MAAM,CAAE,IAAI,CACZ,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,EAAE,CAAC,CAAC,CAAC,CAAC,CAAC,EAAE,CAAC,CAChC,aAAa,CAAE,IAAI,CACnB,OAAO,CAAE,GAAG,CACZ,WAAW,CAAE,cAAc,CAC3B,UAAU,CAAE,GAAG,CAAC,KAAK,AACvB,CAAC,AAED,iCAAK,MAAM,CACX,iCAAK,MAAM,AAEE,CAAC,AACZ,YAAY,CAAE,OAAO,CACrB,aAAa,CAAE,IAAI,AACrB,CAAC,AAED,MAAM,4BAAC,CAAC,AACN,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,EAAE,CAAC,CAAC,CAAC,CAAC,CAAC,EAAE,CAAC,CAChC,aAAa,CAAE,IAAI,CACnB,OAAO,CAAE,IAAI,CACb,SAAS,CAAE,MAAM,CACjB,UAAU,CAAE,IAAI,CAChB,WAAW,CAAE,cAAc,CAC3B,WAAW,CAAE,IAAI,CACjB,gBAAgB,CAAE,IAAI,EAAE,CAAC,CAAC,CAAC,CAAC,CAAC,EAAE,CAAC,CAChC,KAAK,CAAE,OAAO,CACd,MAAM,CAAE,OAAO,AACjB,CAAC\"}"
};
...
const Login = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<main class="${"svelte-rvczwr"}"><div class="${"titleContainer svelte-rvczwr"}"><h1 class="${"svelte-rvczwr"}">Talents du Nord</h1></div>

  <div class="${"mainContainer svelte-rvczwr"}"><h2 class="${"svelte-rvczwr"}">Login</h2>

    <div class="${"errors svelte-rvczwr"}"><ul>${each(errors, error => `<li class="${"svelte-rvczwr"}">${escape(error)}</li>`)}</ul></div>

    <form class="${"svelte-rvczwr"}"><label for="${"username"}" class="${"svelte-rvczwr"}">Username</label>
      <input type="${"text"}" id="${"username"}" required class="${"svelte-rvczwr"}"${add_attribute("value", username, 1)}>

      <label for="${"password"}" class="${"svelte-rvczwr"}">Password</label>
      <input type="${"password"}" id="${"password"}" required class="${"svelte-rvczwr"}"${add_attribute("value", password, 1)}>

      <button type="${"submit"}" class="${"svelte-rvczwr"}">Login</button></form></div></main>`;
});
